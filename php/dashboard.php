  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a href="tambah.php" class="btn btn-sm bg-white mb-0 me-1 mt-2 mt-md-0" >Tambah data</a>
          </li>
          <li class="nav-item">
...
function logout() {
  axios.post('https://client-server-wifal.000webhostapp.com/logout.php')
    .then(response => {
      // Handle success, misalnya mengarahkan pengguna ke halaman login
...
// Temukan elemen tautan logout dalam dokumen
const logoutLink = document.querySelector('.btn-logout');

// Tambahkan event listener untuk memanggil fungsi logout saat tautan logout diklik
